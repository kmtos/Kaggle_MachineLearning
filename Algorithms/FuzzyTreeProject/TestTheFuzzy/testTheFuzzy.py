...
MakeTree(df=df_noStrings, className='Survived', nGiniSplits=10, alpha=.1, giniEndVal=.01/len(df_weights.index), maxDepth=4, idColumn='PassengerId', 
...
ClassifyWithTree(df_test, 
                 ...
                 className='Survived', idColumn='PassengerId', 
