...
#MakeTree(df=df_noStrings, className='Survived', nGiniSplits=10, giniEndVal=.005/len(df_weights.index), maxDepth=5, idColumn='PassengerId', minSamplesSplit=3, df_weights=df_weights,
#         nodeDFIDsFileName='/home/kyletos/Kaggle/Algorithms/FuzzyTreeProject/TestTheFuzzy/Answers/NodeDFIDs_nGiniSplits10_giniEndVal0p01_maxDepth5',
#         nodeValuesFileName='/home/kyletos/Kaggle/Algorithms/FuzzyTreeProject/TestTheFuzzy/Answers/NodeValues_nGiniSplits10_giniEndVal0p01_maxDepth5',
#         nodeDecisionsFileName='/home/kyletos/Kaggle/Algorithms/FuzzyTreeProject/TestTheFuzzy/Answers/NodeDecisions_nGiniSplits10_giniEndVal0p01_maxDepth5')
...
#                 nodeDecisionsFileName='/home/kyletos/Kaggle/Algorithms/FuzzyTreeProject/TestTheFuzzy/Answers/NodeDecisions_nGiniSplits10_giniEndVal0p01_maxDepth5.csv', 
#                 nodeValuesFileName='/home/kyletos/Kaggle/Algorithms/FuzzyTreeProject/TestTheFuzzy/Answers/NodeValues_nGiniSplits10_giniEndVal0p01_maxDepth5.csv')

#paramDictMakeTree = {'className': 'Survived', 'nGiniSplits': 10, 'giniEndVal': .01/len(df_weights.index), 'maxDepth':5, 'idColumn':'PassengerId', 'minSamplesSplit':5,
#                     'nodeDFIDsFileName': '/home/kyletos/Kaggle/Algorithms/FuzzyTreeProject/TestTheFuzzy/Answers/NodeDFIDs_nGiniSplits10_giniEndVal0p01_maxDepth5_',
#                     'nodeValuesFileName': '/home/kyletos/Kaggle/Algorithms/FuzzyTreeProject/TestTheFuzzy/Answers/NodeValues_nGiniSplits10_giniEndVal0p01_maxDepth5_',
#                     'nodeDecisionsFileName': '/home/kyletos/Kaggle/Algorithms/FuzzyTreeProject/TestTheFuzzy/Answers/NodeDecisions_nGiniSplits10_giniEndVal0p01_maxDepth5_'}
...
#CalssifyWithBoost(df_test=df_test, nEstimators=5, maxDepth=7, idColumn=paramDictMakeTree['idColumn'], className=paramDictMakeTree['className'], uniqueClasses=df['Survived'].unique(),  
#                  treeErrorFileName='/home/kyletos/Kaggle/Algorithms/FuzzyTreeProject/TestTheFuzzy/Answers/TreeBoostingErrors_nEst5_maxDepth7_minSplit5', 
#                  nodeValuesFileName=paramDictMakeTree['nodeValuesFileName'], nodeDecisionsFileName=paramDictMakeTree['nodeDecisionsFileName'], 
#                  nodeDFIDsFileName=paramDictMakeTree['nodeDFIDsFileName'], 
#                  boostAnswersFileName='/home/kyletos/Kaggle/Algorithms/FuzzyTreeProject/TestTheFuzzy/Answers/BoostedAnswers_nEst5_maxDepth7_minSplit5')
...
paramDictMakeFuzzyTree = {'className': 'Survived', 'nGiniSplits': 10, 'giniEndVal': .01/len(df_weights.index), 'duality':.95,'maxDepth':5, 'idColumn':'PassengerId', 'minSamplesSplit':5, 'nodeValuesFileName': '/home/kyletos/Kaggle/Algorithms/FuzzyTreeProject/TestTheFuzzy/Answers/NodeValues_nGiniSplits10_giniEndVal0p01_maxDepth5_', 'nodeDecisionsFileName': '/home/kyletos/Kaggle/Algorithms/FuzzyTreeProject/TestTheFuzzy/Answers/NodeDecisions_nGiniSplits10_giniEndVal0p01_maxDepth5_'}
GetFuzzyBoostingTreesErrorsAndWeights(df=df_noStrings, nEstimators=5, rateOfChange=.1, df_weights=df_weights, paramDict=paramDictMakeFuzzyTree, colRandomness=.1, rowRandomness=.1,treeErrorFileName= '/home/kyletos/Kaggle/Algorithms/FuzzyTreeProject/TestTheFuzzy/Answers/TreeBoostingErrors_nEst5_maxDepth5_minSplit5', middleStart=False, middleStartNum=-1)
